...
class BrokerConnConfig(DataClassBase):
    ...
    REDIS_DB = int(os.getenv('REDIS_DB', '5'))  # redis消息队列所在db，请不要在这个db放太多其他键值对，以及方便你自己可视化查看你的redis db，框架里面有的功能会scan扫描unacked的键名，使用单独的db。
    ...
    SQLACHEMY_ENGINE_URL = os.getenv('SQLACHEMY_ENGINE_URL', 'mysql://root:xyztxdys@172.17.0.1:3306/test')
